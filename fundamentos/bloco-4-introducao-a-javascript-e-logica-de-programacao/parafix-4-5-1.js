...
console.log(
  "A jogadora " + name + " " + lastName + " tem " + age + " anos de idade"
);
...
// seguinte formato: "A jogadora Marta Silva foi eleita a melhor
// do mundo por 6 vezes".

console.log('A jogadora Marta Silva foi eleita a melhor do mundo por '+bestInTheWorld.anos.length+' vezes ');

//5 - Acesse a chave medals e faça um console.log no seguinte
// formato: "A jogadora possui 2 medalhas de ouro e 3 medalhas
// de prata".
